...
class Order extends Model
{
    ...
    protected $fillable = ['title', 'description', 'date', 'user_id', 'facility_id', 'payment_account_id', 'status', 'tags', 'total', 'price_group', 'company_name', 'mailing_address', 'purchase_order_number'];
