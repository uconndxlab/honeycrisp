<div class="container">
    ...
    <!-- Form Section -->
    <form action="{{ route('ledgers.store') }}" method="POST" class="ledger-meta-form">
        @csrf
            ...
            <div class="col-md-6">
                ...
                <div class="form-group my-2">
                    ...
                    <select name="facility_id" id="facility" class="form-select">
                        ...
                        @foreach ($facilities as $facility)
                            <option value="{{ $facility->id }}" @if (old('facility', isset($ledger) && $ledger->facility_id == $facility->id)) selected @endif>
                ...
                <div class="form-group my-2">
                    ...
                    <input type="text" name="title" id="title" class="form-control"
                        value="{{ old('title', isset($ledger) ? $ledger->title : '') }}">
                </div>
                ...
                <div class="form-group my-2">
                    ...
                    <input type="date" name="date" id="date" class="form-control"
                        value="{{ old('date', isset($ledger) ? $ledger->date : '') }}">
                </div>
                ...
                <div class="form-group my-2">
                    ...
                    <select name="status" id="status" class="form-select">
                        ...
                        <option value="in_progress" @if (old('status', isset($ledger) && $ledger->status == 'in_progress')) selected @endif>In Progress
                        </option>
        ...
        <div class="row">
            <div class="col-md-6">
                @if (isset($ledger))
                    <button type="submit" id="update-ledger" class="btn btn-primary">Save Ledger Details <i
                            class="bi bi-check"></i></button>
                @else
                    <button type="submit" id="save-ledger" class="btn btn-primary">Add Orders <i
