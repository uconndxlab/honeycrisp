                        ...
                        <div class="row my-3 align-items-center">
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" id="status" name="status">
                                    ...
                                    @foreach ($status_options as $slug => $name)
                                    <option value="{{ $slug }}" {{ $slug==request('status') ? 'selected' : '' }}>
                                        {{ $name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" id="price_group" name="price_group">
                                    ...
                                    <option value="external_forprofit" {{ request('price_group')=='external_forprofit'
                                        ? 'selected' : '' }}>
                                        External For Profit</option>
                                    <option value="external_nonprofit" {{ request('price_group')=='external_nonprofit'
                                        ? 'selected' : '' }}>
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" id="account_type" name="account_type">
                                    ...
                                    <option value="{{ $account_type }}" {{ $account_type==request('account_type')
                                        ? 'selected' : '' }}>
