...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
                        ...
                        <div class="row my-3 align-items-center">
                            <div class="col">
                                ...
                                <select class="form-select" id="facility_id" name="facility_id">
                                    ...
                                    <option value="{{ $facility->id }}" {{ $facility->id == request('facility_id') ?
                                        'selected'
                                        : '' }}>
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" id="price_group" name="price_group">
                                    ...
                                    <option value="internal" {{ request('price_group')=='internal' ? 'selected' : '' }}>
                                        Internal
                                    </option>
                                    <option value="external_for_profit" {{ request('price_group')=='external_for_profit'
                                        ? 'selected' : '' }}>External For Profit</option>
                                    <option value="external_non_profit" {{ request('price_group')=='external_non_profit'
                                        ? 'selected' : '' }}>External Non Profit</option>
                                </select>
                            </div>
            ...
            <small class="d-block py-2">There are <span class="badge bg-dark">{{ $orders->count() }}</span> orders on
                this page, out of
