            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('payment-accounts.show', $paymentAccount->id) }}" class="btn btn-primary">View</a>
                            <a href="{{ route('payment-accounts.edit', $paymentAccount->id) }}" class="btn btn-secondary">Edit</a>
                            <form action="{{ route('payment-accounts.destroy', $paymentAccount->id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
